...
public class PlantWateringService extends IntentService {
    ...
    private void handleActionUpdatePlantWidgets() {
        ...
        Cursor cursor = getContentResolver().query(
                PLANTS_URI, null, null, null, PlantContract.PlantEntry.COLUMN_LAST_WATERED_TIME
        );
        ...
        PlantWidgetProvider.updatePlantWidgets(this, appWidgetManager, imageRes, appWidgetIds, plantId, canWater);
    }
}
